...
# Build requirements
RUN apt-get -y --no-install-recommends --no-upgrade -qq install g++-multilib automake autotools-dev bsdmainutils build-essential ca-certificates ccache clang clang-9 curl
